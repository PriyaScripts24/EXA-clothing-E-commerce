      ...
      >
        ...
        <div class="md:w-[630px] flex flex-col gap-5">
          ...
          <p class="font-medium text-[12px] px-5 text-justify">
            ...
            comfortable apparel for men, women, and children, designed to suit
            every occasion, taste, and lifestyle. Whether you’re looking for
            everyday wear, office outfits, or special event attire, Exa Clothing
            brings you the best of both traditional and modern styles, with a
            focus on durability, comfort, and affordability. <br />
            Our mission is to make fashion accessible to everyone, by offering a
            seamless online shopping experience that combines convenience with
            curated collections tailored to the diverse preferences of our
            customers. We take pride in sourcing the finest fabrics,
            collaborating with talented designers, and ensuring that every
            product meets our high standards of quality.
          </p>
        </div>
      </div>
    </section>
