            ...
            >
              ...
              <div class="flex gap-2">
                ...
                >
                  ...
                  <p v-if="index < 3" class="fond-bold text-[20px]">:</p>
                </div>
              </div>
            </div>
            <button
...
export default {
  ...
  mounted() {
    ...
    setInterval(() => {
      const date = new Date();
      this.time = formatDate(date, "hh:mm:ss:A");
    }, 1000);
    this.date = formatDate(new Date(), "DD-MM-YYYY MMM ddd");
  },
};
</script>
<style>
